...
directory = "output/16.3/sim"+str(sim_id)
...
# particle_counter = ncells * nnode
# for i in range(ncells):
    # for j in range(inner_particle_counts[i]):
        # inner_particles[i].append(system.part.add(pos=[inner_positions[i][j][0],
                                                       # inner_positions[i][j][1],
                                                       # inner_positions[i][j][2]],
                                                  # mass=particle_mass,
                                                  # id=particle_counter,
                                                  # type=inner_particle_types[i]))
