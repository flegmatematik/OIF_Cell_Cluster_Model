...
directory = "output/2022-03-04/sim"+str(sim_id)
...
for id, point in enumerate(cell.mesh.points):
    if point_left is None or point.get_pos()[0] - cell.get_origin()[0] < point_left.get_pos()[0]:
        point_left = point
    if point_right is None or point.get_pos()[0] - cell.get_origin()[0] > point_right.get_pos()[0]:
        point_right = point
        
print("left " + str(point_left.get_pos()))
print("right " + str(point_right.get_pos()))
